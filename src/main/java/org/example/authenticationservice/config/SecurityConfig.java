...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/docs", "/docs/**", "/v3/api-docs/**", "/swagger-ui/**").permitAll()
                        .requestMatchers(
                                "/api/v1/organizations",
                                "/api/v1/organizations/login",
                                "/api/v1/organizations/refresh",
                                "/api/v1/organizations/lookup",
                                "/api/v1/organizations/forgot-password",
                                "/api/v1/organizations/reset-password",
                                "/api/v1/organizations/reset-password/verify",
                                "/api/v1/admin/login",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(List.of("https://naguiboserver.dpdns.org", "https://recruitment-systemm.github.io", "http://localhost:5173"));
